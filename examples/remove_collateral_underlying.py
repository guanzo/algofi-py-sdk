...
txn = client.prepare_remove_collateral_underlying_transactions(
    symbol, int(user_active_collateral * 0.10), sender
)
txn.sign_with_private_key(sender, key)
txn.submit(client.algod, wait=True)
